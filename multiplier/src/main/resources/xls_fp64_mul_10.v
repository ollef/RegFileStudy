module XLSFloatingPointMultiplier_10_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  reg p9_result_sign__1;
  reg [10:0] p9_result_exp__4;
  reg [52:0] p9_result_fraction__4;
  always_ff @ (posedge clk) begin
    p9_result_sign__1 <= p8_result_sign__1;
    p9_result_exp__4 <= p8_result_exp__4;
    p9_result_fraction__4 <= p8_result_fraction__4;
  end

  // ===== Pipe stage 10:
  wire [64:0] p10_tuple_756_comb;
  assign p10_tuple_756_comb = {p9_result_sign__1, p9_result_exp__4, p9_result_fraction__4};

  // Registers for pipe stage 10:
  reg [64:0] p10_tuple_756;
  always_ff @ (posedge clk) begin
    p10_tuple_756 <= p10_tuple_756_comb;
  end
  assign out = p10_tuple_756;
endmodule
