module XLSFloatingPointMultiplier_2_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  assign p1_eq_627_comb = p1_a_bexp__2_comb == p1_high_exp_comb;
  assign p1_eq_628_comb = p1_a_fraction_comb == p1_literal_598_comb;
  assign p1_eq_629_comb = p1_b_bexp__1_comb == p1_high_exp_comb;
  assign p1_eq_630_comb = p1_b_fraction_comb == p1_literal_598_comb;
  ...
  assign p1_has_inf_arg_comb = p1_eq_627_comb & p1_eq_628_comb | p1_eq_629_comb & p1_eq_630_comb;
  ...
  assign p1_is_result_nan_comb = ~(~p1_eq_627_comb | p1_eq_628_comb) | ~(~p1_eq_629_comb | p1_eq_630_comb) | p1_has_0_arg_comb & p1_has_inf_arg_comb;
  ...
  reg [107:0] p1_fraction;
  reg [12:0] p1_exp__1;
  reg p1_has_inf_arg;
  reg p1_is_result_nan;
  reg p1_result_sign__1;
  always_ff @ (posedge clk) begin
    p1_fraction <= p1_fraction_comb;
    p1_exp__1 <= p1_exp__1_comb;
  ...
  wire [12:0] p2_add_684_comb;
  wire [12:0] p2_exp__3_comb;
  wire p2_is_subnormal_comb;
  wire [11:0] p2_result_exp_comb;
  wire [11:0] p2_result_exp__1_comb;
  wire p2_and_reduce_693_comb;
  wire [52:0] p2_result_fraction_comb;
  wire [52:0] p2_result_fraction__3_comb;
  wire [52:0] p2_nan_fraction_comb;
  wire [10:0] p2_result_exp__4_comb;
  wire [52:0] p2_result_fraction__4_comb;
  wire [64:0] p2_tuple_702_comb;
  assign p2_literal_594_comb = 107'h000_0000_0000_0000_0000_0000_0000;
  assign p2_fraction__1_comb = p1_fraction >> p1_fraction[107];
  assign p2_sticky_comb = {p2_literal_594_comb, p1_fraction[0]};
  assign p2_fraction__2_comb = p2_fraction__1_comb | p2_sticky_comb;
  assign p2_exp__2_comb = p1_exp__1 + {12'h000, p1_fraction[107]};
  ...
  assign p2_ne_673_comb = p2_fraction__4_comb[51:0] != 52'h0_0000_0000_0000;
  assign p2_greater_than_half_way_comb = p2_fraction__4_comb[52] & p2_ne_673_comb;
  assign p2_fraction__5_comb = p2_fraction__4_comb[105:53];
  assign p2_do_round_up_comb = p2_greater_than_half_way_comb | ~(~p2_fraction__4_comb[52] | p2_ne_673_comb | ~p2_fraction__4_comb[53]);
  ...
  assign p2_add_684_comb = p2_exp__2_comb + 13'h0001;
  assign p2_exp__3_comb = p2_fraction__7_comb[53] ? p2_add_684_comb : p2_exp__2_comb;
  assign p2_is_subnormal_comb = $signed(p2_exp__3_comb) <= $signed(p2_literal_596_comb);
  assign p2_result_exp_comb = p2_exp__3_comb[11:0];
  assign p2_result_exp__1_comb = p2_result_exp_comb & {12{~p2_is_subnormal_comb}};
  assign p2_and_reduce_693_comb = &p2_result_exp__1_comb[10:0];
  assign p2_result_fraction_comb = p2_fraction__7_comb[52:0];
  assign p2_result_fraction__3_comb = p2_result_fraction_comb & {53{~(p1_has_inf_arg | p2_result_exp__1_comb[11] | p2_and_reduce_693_comb | p2_is_subnormal_comb)}};
  assign p2_nan_fraction_comb = 53'h10_0000_0000_0000;
  assign p2_result_exp__4_comb = p1_is_result_nan | p1_has_inf_arg | p2_result_exp__1_comb[11] | p2_and_reduce_693_comb ? p1_high_exp_comb : p2_result_exp__1_comb[10:0];
  assign p2_result_fraction__4_comb = p1_is_result_nan ? p2_nan_fraction_comb : p2_result_fraction__3_comb;
  assign p2_tuple_702_comb = {p1_result_sign__1, p2_result_exp__4_comb, p2_result_fraction__4_comb};

  // Registers for pipe stage 2:
  reg [64:0] p2_tuple_702;
  always_ff @ (posedge clk) begin
    p2_tuple_702 <= p2_tuple_702_comb;
  end
  assign out = p2_tuple_702;
endmodule
