module XLSFloatingPointMultiplier_8_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  // ===== Pipe stage 8:
  wire [64:0] p8_tuple_744_comb;
  assign p8_tuple_744_comb = {p7_result_sign__1, p7_result_exp__4, p7_result_fraction__4};

  // Registers for pipe stage 8:
  reg [64:0] p8_tuple_744;
  always_ff @ (posedge clk) begin
    p8_tuple_744 <= p8_tuple_744_comb;
  end
  assign out = p8_tuple_744;
endmodule
