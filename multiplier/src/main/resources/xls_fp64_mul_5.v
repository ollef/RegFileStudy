module XLSFloatingPointMultiplier_5_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  // ===== Pipe stage 5:
  wire [64:0] p5_tuple_726_comb;
  assign p5_tuple_726_comb = {p4_result_sign__1, p4_result_exp__4, p4_result_fraction__4};

  // Registers for pipe stage 5:
  reg [64:0] p5_tuple_726;
  always_ff @ (posedge clk) begin
    p5_tuple_726 <= p5_tuple_726_comb;
  end
  assign out = p5_tuple_726;
endmodule
