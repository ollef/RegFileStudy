module XLSFloatingPointMultiplier_4_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  // ===== Pipe stage 4:
  wire [64:0] p4_tuple_720_comb;
  assign p4_tuple_720_comb = {p3_result_sign__1, p3_result_exp__4, p3_result_fraction__4};

  // Registers for pipe stage 4:
  reg [64:0] p4_tuple_720;
  always_ff @ (posedge clk) begin
    p4_tuple_720 <= p4_tuple_720_comb;
  end
  assign out = p4_tuple_720;
endmodule
