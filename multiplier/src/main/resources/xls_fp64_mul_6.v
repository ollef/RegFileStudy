module XLSFloatingPointMultiplier_6_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  // ===== Pipe stage 6:
  wire [64:0] p6_tuple_732_comb;
  assign p6_tuple_732_comb = {p5_result_sign__1, p5_result_exp__4, p5_result_fraction__4};

  // Registers for pipe stage 6:
  reg [64:0] p6_tuple_732;
  always_ff @ (posedge clk) begin
    p6_tuple_732 <= p6_tuple_732_comb;
  end
  assign out = p6_tuple_732;
endmodule
