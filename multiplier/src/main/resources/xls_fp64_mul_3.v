module XLSFloatingPointMultiplier_3_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  assign p3_tuple_714_comb = {p2_result_sign__1, p3_result_exp__4_comb, p3_result_fraction__4_comb};

  // Registers for pipe stage 3:
  reg [64:0] p3_tuple_714;
  always_ff @ (posedge clk) begin
    p3_tuple_714 <= p3_tuple_714_comb;
  end
  assign out = p3_tuple_714;
endmodule
