module XLSFloatingPointMultiplier_7_core(
  input wire clk,
  input wire [64:0] a,
  input wire [64:0] b,
  ...
  // ===== Pipe stage 7:
  wire [64:0] p7_tuple_738_comb;
  assign p7_tuple_738_comb = {p6_result_sign__1, p6_result_exp__4, p6_result_fraction__4};

  // Registers for pipe stage 7:
  reg [64:0] p7_tuple_738;
  always_ff @ (posedge clk) begin
    p7_tuple_738 <= p7_tuple_738_comb;
  end
  assign out = p7_tuple_738;
endmodule
